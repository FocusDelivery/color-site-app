      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-6 reveal">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a href="https://go.perfectpay.com.br/PPU38CQESG3" target="_self" rel="noopener noreferrer" className="btn-primary rounded-full px-7 py-4 text-base inline-flex items-center gap-2 pulse-glow">
