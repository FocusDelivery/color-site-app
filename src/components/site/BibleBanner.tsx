    ...
    <section className="relative py-10 md:py-16">
      <div className="max-w-6xl mx-auto px-5 md:px-8 reveal">
        <div className="relative rounded-[28px] overflow-hidden border border-white/10 shadow-[0_40px_100px_-30px_rgba(139,92,246,0.6)] group">
          ...
          <div className="absolute inset-0 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-6 md:p-10">
            ...
            <div className="bg-white/95 backdrop-blur rounded-2xl p-5 md:p-6 shadow-xl max-w-xs w-full">
              ...
              <a href="https://go.perfectpay.com.br/PPU38CQE8L6" className="btn-primary w-full mt-4 rounded-xl py-3 text-sm inline-flex items-center justify-center gap-2">
                🔒 COMEÇAR AGORA!
              </a>
