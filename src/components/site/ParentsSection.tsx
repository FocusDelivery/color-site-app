          ...
          <div className="relative mx-auto max-w-md">
            ...
            <div className="relative rounded-[28px] border border-white/15 bg-gradient-to-b from-[#1a0a3d] to-[#0b0420] p-6 md:p-8 shadow-[0_40px_120px_-20px_rgba(255,79,163,0.5)]">
              ...
              <div className="flex items-baseline gap-1 mt-1">
                ...
                <span className="text-white/60 text-sm mb-2">Pagamento Mensal</span>
              </div>

              <div className="mt-5 grid grid-cols-3 gap-2 text-center">
                {[
                  { icon: "🚀", label: "Acesso imediato" },
                  { icon: "👑", label: "Pagamento mensal" },
              ...
              <a href="https://go.perfectpay.com.br/PPU38CQESG3" target="_blank" rel="noopener noreferrer" className="btn-primary w-full mt-6 rounded-2xl py-4 text-base inline-flex items-center justify-center gap-2 pulse-glow">
